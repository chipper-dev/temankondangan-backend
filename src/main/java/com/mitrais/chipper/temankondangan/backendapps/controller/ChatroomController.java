...
public class ChatroomController extends CommonResource {
	...
	public ResponseEntity<ResponseBody> createChatroom(@RequestBody CreateChatroomWrapper wrapper,
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ResponseBody> deleteChatrooms(@RequestBody DeleteChatroomWrapper wrapper,
			HttpServletRequest request) {
